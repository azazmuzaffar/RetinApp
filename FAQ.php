...
<html lang="en">
  <head>
    ...
    <!-- >>> Custom CSS <<< -->
    <link rel="stylesheet" href="./sass/pages/FAQ/FAQ.css" />
  </head>
  <body>
    <!-- >>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<< -->
    <!-- >>>>>>>>>>>>>> Konfidencial <<<<<<<<<<<<<<<< -->
    ...
    <div class="--about--us--">
      <div class="container">
        ...
        <div class="heading-area-">
          <!-- >>>>>>>>> Tagline <<<<<<<< -->
          <p class="--main-p--">Frequently Question</p>
          <!-- >>>>>>>>> Main Heading <<<<<<<< -->
          <h3 class="--main-h--">Do you have any question?</h3>
        </div>

        <!-- >>>>>>> All Frequently Asked Question <<<<<< -->

        <div class="--frequently--asked--question--">
          <!-- >>>>>>> Each --f-a-q--1-- have each question <<<<<< -->
          <!-- >>>>>>> Question # 1 <<<<<< -->
          <div class="--f-a-q-- --f-a-q--1-">
            <input class="--toggle-- active" id="faq-drawer" type="checkbox" />
            <!-- >>>>>>> Question <<<<<< -->
            <h2 class="--question--">
              <label for="faq-drawer">Where I can find the RetinApp?</label>
            </h2>
            <!-- >>>>>>> Answer <<<<<< -->
          ...
          <!-- >>>>>>> Question # 2 <<<<<< -->
          <div class="--f-a-q-- --f-a-q--2--">
            <!-- Change 8 in "faq-drawer-8" with queston number -->
            <input class="--toggle--" id="faq-drawer-2" type="checkbox" />
            <!-- >>>>>>> Question <<<<<< -->
            <!-- Change 8 in "faq-drawer-8" with queston number -->
            <h2 class="--question--">
              <label for="faq-drawer-2">Where I can find the RetinApp?</label>
            </h2>
            <!-- >>>>>>> Answer <<<<<< -->
            <div class="faq-drawer__content-wrapper">
              <div class="faq-drawer__content">
          ...
          <!-- >>>>>>> Question # 3 <<<<<< -->
          <div class="--f-a-q-- --f-a-q--3--">
            <!-- Input responsible for toggling showText/hideText  -->
            <!-- Change 8 in "faq-drawer-8" with queston number -->
            <input class="--toggle--" id="faq-drawer-3" type="checkbox" />
            <!-- >>>>>>> Question <<<<<< -->
            <!-- Change 8 in "faq-drawer-8" with queston number -->
            <h2 class="--question--">
              <label for="faq-drawer-3">Where I can find the RetinApp?</label>
            </h2>
            <!-- >>>>>>> Answer <<<<<< -->
            <div class="faq-drawer__content-wrapper">
              <div class="faq-drawer__content">
          ...
          <!-- >>>>>>> Question # 3 <<<<<< -->
          <div class="--f-a-q-- --f-a-q--4--">
            <!-- Input responsible for toggling showText/hideText  -->
            <!-- Change 8 in "faq-drawer-8" with queston number -->
            <input class="--toggle--" id="faq-drawer-4" type="checkbox" />
            <!-- >>>>>>> Question <<<<<< -->
            <!-- Change 8 in "faq-drawer-8" with queston number -->
            <h2 class="--question--">
              <label for="faq-drawer-4">Where I can find the RetinApp?</label>
            </h2>
            <!-- >>>>>>> Answer <<<<<< -->
            <div class="faq-drawer__content-wrapper">
              <div class="faq-drawer__content">
          ...
          <!-- >>>>>>> Question # 3 <<<<<< -->
          <div class="--f-a-q-- --f-a-q--5--">
            <!-- Input responsible for toggling showText/hideText  -->
            <!-- Change 8 in "faq-drawer-8" with queston number -->
            <input class="--toggle--" id="faq-drawer-5" type="checkbox" />
            <!-- >>>>>>> Question <<<<<< -->
            <!-- Change 8 in "faq-drawer-8" with queston number -->
            <h2 class="--question--">
              <label for="faq-drawer-5">Where I can find the RetinApp?</label>
            </h2>
            <!-- >>>>>>> Answer <<<<<< -->
            <div class="faq-drawer__content-wrapper">
              <div class="faq-drawer__content">
          ...
          <!-- >>>>>>> Question # 6 <<<<<< -->
          <div class="--f-a-q-- --f-a-q--6--">
            <!-- Input responsible for toggling showText/hideText  -->
            <!-- Change 8 in "faq-drawer-8" with queston number -->
            <input class="--toggle--" id="faq-drawer-6" type="checkbox" />
            <!-- >>>>>>> Question <<<<<< -->
            <!-- Change 8 in "faq-drawer-8" with queston number -->
            <h2 class="--question--">
              <label for="faq-drawer-6">Where I can find the RetinApp?</label>
            </h2>
            <!-- >>>>>>> Answer <<<<<< -->
            <div class="faq-drawer__content-wrapper">
              <div class="faq-drawer__content">
          ...
          <div class="--f-a-q-- --f-a-q--3--">
            <!-- Input responsible for toggling showText/hideText  -->
            <!-- Change 8 in "faq-drawer-8" with queston number -->
            <input class="--toggle--" id="faq-drawer-7" type="checkbox" />
            <!-- >>>>>>> Question <<<<<< -->
            <!-- Change 8 in "faq-drawer-8" with queston number -->
            <h2 class="--question--">
              <label for="faq-drawer-7">Where I can find the RetinApp?</label>
            </h2>
            <!-- >>>>>>> Answer <<<<<< -->
            <div class="faq-drawer__content-wrapper">
              <div class="faq-drawer__content">
          ...
          <div class="--f-a-q-- --f-a-q--3--">
            <!-- Input responsible for toggling showText/hideText  -->
            <!-- Change 8 in "faq-drawer-8" with queston number -->
            <input class="--toggle--" id="faq-drawer-8" type="checkbox" />
            <!-- >>>>>>> Question <<<<<< -->
            <!-- Change 8 in "faq-drawer-8" with queston number -->
            <h2 class="--question--">
              <label for="faq-drawer-8">Where I can find the RetinApp?</label>
            </h2>
            <!-- >>>>>>> Answer <<<<<< -->
            <div class="faq-drawer__content-wrapper">
              <div class="faq-drawer__content">
