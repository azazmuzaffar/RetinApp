            ...
            <table class="responsive-table">
              ...
              <thead class="responsive-table__head">
                <tr class="responsive-table__row">
                  ...
                  <th class="responsive-table__head__title responsive-table__head__title--age">Phone #</th>
              ...
              <?php
                ...
                <tr class="responsive-table__row">
                  ...
                  <td class="responsive-table__body__text responsive-table__body__text--age"><?php echo $patientEmail ?></td>
                  <td class="responsive-table__body__text responsive-table__body__text--age"><?php echo $patientContact ?></td>
                  ...
                  <?php if($feedback === "") {} else {?>
                    <td class="responsive-table__body__text responsive-table__body__text--report">
                    <a href="./reports/update-report.php?report_id=<?php echo $id ?>" target="_blank"><i class="fas fa-edit"></i> </a>
                  </td>
                  <?php } ?>
                </tr>
                    <?php } ?>
