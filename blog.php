...
<html lang="en">
  <head>
    ...
    <!-- >>> Custom CSS <<< -->
    <link rel="stylesheet" href="./sass/pages/blog/blog.css" />
  </head>
  <body>
    <!-- >>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<< -->
    <!-- >>>>>>>>>>>>>> Konfidencial <<<<<<<<<<<<<<<< -->
          ...
          <div class="col-md-6 col-lg-4">
            <a href="./blogs/blog-1.php">
              ...
              <div class="blog blog-1">
                <div class="--blog-img--">
                  <img src="./images/blog/blogs/blog-1.jpg" alt="regras básicas de acompanhante" />
                </div>
                <div class="--blog--details--">
                  ...
                  <div class="description">
                    <p>
                      Diabetes is rising in epidemic proportions with over 9% population of the world now diabetic. According to WHO (World Health
          ...
          <div class="col-md-6 col-lg-4">
            <a href="./blogs/blog-1.php">
              <div class="blog blog-2">
                <!-- >>>>>>>> Blog Image <<<<<<< -->
                <div class="--blog-img--">
                  <img src="./images/blog/blogs/blog-2.jpg" alt="regras básicas de acompanhante" />
                </div>
                <div class="--blog--details--">
                  <!-- >>>>>>>> Blog Title <<<<<<< -->
                  <div class="title">
                    <h2>Tests Used to Detect Diabetes</h2>
                  </div>
                  <!-- >>>>>>>> Blog Description <<<<<<< -->
                  <div class="description">
                    <p>
          ...
          <div class="col-md-6 col-lg-4">
            <a href="./blogs/blog-1.php">
              <div class="blog blog-3">
                <!-- >>>>>>>> Blog Image <<<<<<< -->
                <div class="--blog-img--">
                  <img src="./images/blog/blogs/blog-3.jpg" alt="regras básicas de acompanhante" />
                </div>
                <div class="--blog--details--">
                  <!-- >>>>>>>> Blog Title <<<<<<< -->
                  <div class="title">
                    <h2>How Are Diabetes Diagnosed?</h2>
                  </div>
                  <!-- >>>>>>>> Blog Description <<<<<<< -->
                  <div class="description">
                    <p>
