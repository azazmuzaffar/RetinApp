...
<html lang="en">
  <head>
    ...
    <!-- >>> Title & Favicon <<< -->
    <title>Patient Reports - RetinApp</title>
              ...
              <div class="--select-city--">
                <div class="dropdown">
                  ...
                  <?php
                    ...
                    {
                      $ascending = '';
                      $reviewed = 'class="active"';
                      $notreviewed = '';
                  ?>
                        <span>Reviewed</span>

                  <?php } else if(isset($_GET['notReviewed'])) { 
                    
                    $notreviewed = 'class="active"';
                    $ascending = '';
                    $reviewed = '';
            ...
            <table class="responsive-table">
              ...
              <thead class="responsive-table__head">
                <tr class="responsive-table__row">
                  ...
                  <th class="responsive-table__head__title responsive-table__head__title--date">Checkup Date</th>
                  <th class="responsive-table__head__title responsive-table__head__title--report">Results</th>
                  <th class="responsive-table__head__title responsive-table__head__title--report">Other Details</th>
                  <th class="responsive-table__head__title responsive-table__head__title--delete">Report</th>
              ...
              <?php
                ...
                $sql = "SELECT id, patientName, patientEmail, patientContact, patientAge, patientGender, checkupDate, results, otherIssues, feedback, patientPDFReport, cnic FROM reports";
                ...
                if ($result->num_rows > 0) {
                  ...
                  while($row = $result->fetch_assoc()) {
                    ...
                    $patientPDFReport = $row["patientPDFReport"];    
                    $cnic = $row["cnic"];    
                ...
                <tr class="responsive-table__row">
                  ...
                  <td class="responsive-table__body__text responsive-table__body__text--age"><?php echo $patientAge ?></td>
                  <td class="responsive-table__body__text responsive-table__body__text--age"><?php echo $patientGender ?></td>
                  <td class="responsive-table__body__text responsive-table__body__text--date"><?php echo $checkupDate ?></td>
                  <td class="responsive-table__body__text responsive-table__body__text--date"><?php echo $results ?></td>
                  <td class="responsive-table__body__text responsive-table__body__text--date"><?php echo $otherIssues ?></td>
                  <td class="responsive-table__body__text responsive-table__body__text--report">
                    <a href="./reports/reports-view.php?report_id=<?php echo $id ?>" target="_blank"><i class="fas fa-file-pdf"></i></a>
                  </td>
                  <!-- Show edit option if feedback already provided -->
                  <?php if($feedback === "") {} else {?>
                  <td class="responsive-table__body__text responsive-table__body__text--report">
                    <a href="./reports/reports_edit_view.php?report_id=<?php echo $id ?>" target="_blank"><i class="fas fa-edit"></i> </a>
                  </td>
                  <?php } ?>
                </tr>
                    <?php } ?>
              ...
              <?php
                     } else if(isset($_GET['notReviewed']))
                    {
            ...
            <!-- Not Revewed -->
              ...
              <?php } else{ ?>   
                ...
                <?php
                     ...
                     $patiName = $_POST['patientName'];  
      
                     //to prevent from mysqli injection  
                     $patiName = stripcslashes($patiName);  
                     $patiName = mysqli_real_escape_string($con, $patiName);   
                          
                     if($patiName === $patientName){
                     ?>
