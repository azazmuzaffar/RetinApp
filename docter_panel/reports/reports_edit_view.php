  ...
  <body>
          ...
          <div class="container reports__view">
            ...
            <div class="--patient--">
              ...
              <form action="./reports-view.php?report_id=<?php echo $report_id; ?>" method="post">
                <textarea name="comment" placeholder="Add your comment."  required autofocus><?php echo $doctorFeedback ?></textarea>
                <button id="reviewedit" type="submit" name="submit">Update Feedback</button>
    ...
    if($recordAdded){
      ...
      '<script type="text/JavaScript"> 
          $("#reviewedit").css("display", "none");
          document.getElementById("recordAddedMessage").innerHTML = "The Feedback has been updated!";
      </script>';
    }
