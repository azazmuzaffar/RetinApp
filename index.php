...
<html lang="en">
  <head>
    ...
    <!-- >>> Title & Favicon <<< -->
    <title>RetinApp - We are Intelligent</title>
  ...
  <body>
            ...
            <a class="nav-link make-login" href="#">
              <svg width="24" height="24" xmlns="http://www.w3.org/2000/svg">
                <g fill="none" fill-rule="evenodd">
                  ...
                  <path
                    fill="#ef4126"
                    d="M12 16c3.704 0 7.037.667 10 2v4H2v-4c2.963-1.333 6.296-2 10-2zm0-14a5 5 0 1 1 0 10 5 5 0 0 1 0-10z"
                    fill="#C9A882"
                  />
                </g>
              </svg>
    ...
    <div class="--banner--">
      ...
      <div class="--banner-content--">
        <h2>Retin<span>App</span></h2>
        <p>
          <span>RetinApp</span> is a mobile based application which targets the medical needs of the society. This application helps detect the
          diabetic symptoms and its severity without any need of long and painful blood tests.
        </p>
        <ul>
          <li>
      ...
      <div class="container">
        ...
        <div class="--frequently--asked--question--">
          ...
          <div class="--f-a-q-- --f-a-q--1-">
            <input class="--toggle--" id="faq-drawer" type="checkbox" />
            <!-- >>>>>>> Question <<<<<< -->
            <label class="--question--" for="faq-drawer">How to download the RetinApp?</label>
            <!-- >>>>>>> Answer <<<<<< -->
            <div class="faq-drawer__content-wrapper">
              <div class="faq-drawer__content">
                <p>
                  ...
                  medical needs of the society. This application helps detect the diabetic symptoms and its severity without any need of long.
                </p>
              </div>
            </div>
          </div>
          ...
          <div class="--f-a-q-- --f-a-q--2--">
            ...
            <!-- >>>>>>> Question <<<<<< -->
            <label class="--question--" for="faq-drawer-2">How to use the RetinApp?</label>
            <!-- >>>>>>> Answer <<<<<< -->
            <div class="faq-drawer__content-wrapper">
              <div class="faq-drawer__content">
                <p>
          ...
          <div class="--f-a-q-- --f-a-q--3--">
            ...
            <input class="--toggle-- active" id="faq-drawer-3" type="checkbox" />

            <!-- >>>>>>> Question <<<<<< -->
            <label class="--question--" for="faq-drawer-3">Where I can find the RetinApp?</label>
            <!-- >>>>>>> Answer <<<<<< -->
            <div class="faq-drawer__content-wrapper">
              <div class="faq-drawer__content">
                <p>
